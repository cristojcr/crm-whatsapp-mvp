        ...
        if (loading) {
                return (
                    <div style={styles.loadingContainer}>
                        ...
                        {/* A tag <style> foi movida para fora ou removida para corrigir o erro de compilação.
                            O ideal é colocar este CSS em um arquivo .css global ou usar bibliotecas de estilo.
                            Por agora, vamos remover para que o componente compile.
                        */}
                    </div>
                );
            }
