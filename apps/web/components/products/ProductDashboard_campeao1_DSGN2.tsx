...
const ProductDashboard = () => {
  ...
  const styles = {
    ...
    table: {
      ...
      tableLayout: 'fixed' // ✨ Larguras fixas para evitar movimento das colunas
    },
    tableHeader: {
    ...
    // ✨ LARGURAS FIXAS DAS COLUNAS - ZERO MOVIMENTO
    thProduct: { width: '25%' },      // Produto/Serviço (mais espaço para nome+descrição)
    thProfessional: { width: '15%' }, // Profissional
    thCategory: { width: '12%' },     // Categoria
    thPrice: { width: '10%' },        // Preço
    thDuration: { width: '10%' },     // Duração
    thLinks: { width: '10%' },        // Links
    thStatus: { width: '10%' },       // Status
    thActions: { width: '8%' },       // Ações (botões)
    td: {
      padding: '12px 24px',
      ...
      height: '60px' // ✅ VOLTA: altura fixa para estabilidade
    },
    // ✅ TEXTO NORMAL - VOLTAR AO FUNCIONAMENTO ORIGINAL
    productName: {
      fontSize: '14px',
      fontWeight: '600',
      color: 'inherit',
      ...
      whiteSpace: 'nowrap'
      // ✅ SEM forçar largura fixa - comportamento natural original
    },
    productDescription: {
      fontSize: '13px',
      color: 'inherit',
      margin: '4px 0 0 0', // ✅ Margin original
      maxWidth: '280px', // ✅ Largura original
      overflow: 'hidden',
      textOverflow: 'ellipsis',
      whiteSpace: 'nowrap',
      display: 'block'
      // ✅ SEM forçar - comportamento natural original
    },
    statusBadge: {
      display: 'inline-flex',
      padding: '4px 12px',
  ...
  deleteButtonHover: {
    ...
    // ✅ LINHA DA TABELA - ALTURA FIXA PARA ESTABILIDADE
    tableRow: {
      transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)',
      position: 'relative',
      height: '60px' // ✅ Altura fixa para estabilidade
    },
    tableRowHover: {
      ...
      <div style={styles.container}>
        <div style={styles.spinner}>
          ...
          <style>{`
            ...
            /* ✅ FORÇAR TRUNCAMENTO SEMPRE - NUNCA PERMITIR EXPANSÃO */
            tbody td div div {
            ...
            /* ✅ ESPECIFICAMENTE NO HOVER - MANTER TRUNCAMENTO */
                  ...
                  >
                    <td style={{
                      ...
                      <div 
                        ...
                        style={{ 
                          height: '36px', // ✨ Container com altura fixa
                          overflow: 'hidden', // ✨ Cortar qualquer conteúdo extra
                          display: 'flex',
                          flexDirection: 'column',
                          justifyContent: 'center'
                        }}
